...
Be specific and detailed."""
        ...
        response = self.bedrock_runtime.invoke_model(
            ...
            body=json.dumps({
                "prompt": f"\n\nHuman: {prompt}\n\nAssistant: I'll analyze this presentation request and provide a structured plan.\n\n```json\n",
                "max_tokens": 2000,
                "temperature": 0.7
            }),
    ...
    def _get_loan_portfolio_structure(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "num_slides": 15,
            "design_theme": "modern",
            "color_scheme": {"primary": "1E3A8A", "accent": "DC2626"},
            "sections": [
                {
                    "title": "Loan Portfolio",
                    "slide_type": "chart",
                    "content": ["Portfolio composition", "Net Loans – 2Q'20: $2.3 Billion"],
                    "chart_data": {
                        "type": "doughnut",
                        "categories": [
                        ...
                        "center_text": "Net Loans – 2Q'20: $2.3 Billion"
                    }
                },
                {
    ...
    def _create_title_slide(self, prs: Presentation, section: Dict, colors: Dict):
        ...
        title.text = section.get('title', 'Presentation')
    ...
    def _create_doughnut_chart(self, slide, chart_data: Dict, colors: Dict):
        ...
        x, y, cx, cy = Inches(1), Inches(2), Inches(5), Inches(4.5)
        ...
        if 'center_text' in chart_data:
            ...
            textbox = slide.shapes.add_textbox(center_x, center_y, Inches(3), Inches(1))
            text_frame = textbox.text_frame
            text_frame.text = chart_data['center_text']
            text_frame.paragraphs[0].alignment = PP_ALIGN.CENTER
            text_frame.paragraphs[0].font.bold = True
        
        # Add highlights on the right if content exists
        if 'content' in chart_data:
            right_x = Inches(7)
            right_y = Inches(2)
            
            for i, highlight in enumerate(chart_data.get('content', [])):
                textbox = slide.shapes.add_textbox(right_x, right_y + (i * Inches(0.8)), Inches(5), Inches(0.7))
                text_frame = textbox.text_frame
